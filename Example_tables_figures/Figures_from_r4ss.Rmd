...
for(imod in 1:n_models) {
  ...
  plotInfoTable = read.csv(paste0('C:/Assessment_template/r4ss/plots_',mod_num,'/plotInfoTable_',mod_num,'_final.csv'))
...
![`r plotInfoTable_mod1[25,2]` \label{`r paste0('fig:mod1_', plotInfoTable_mod1[25,5])`}](`r plotInfoTable_mod1[25,1]`)
...
#      cat('\n![', S_R_mod1[i,2], ' \\label{fig:mod1_', i, '_', S_R_mod1[i, 9], '}](', S_R_mod1[i, 1], ')\n', sep='')
#}
```
...
```{r, results='asis'}
#     # Plot all of the timeseries plots
#     for(i in 1:10){ #dim(AALComp_mod1)[1]) {
#         
#      # find matches to multi-page plots
...
#      } else {
#      
#     cat('\n![', AALComp_mod1[i,2], ' \\label{fig:mod1_', i, '_', AALComp_mod1[i, 9], '}](', AALComp_mod1[i, 1], ')\n', sep='')
# } }
```
