...
# 0.777		# rebuidling SPR - second catch stream
...
#_Fcast_years:  beg_selex, end_selex, beg_relF, end_relF  (enter actual year, or values of 0 or -integer to be rel. endyr)
 0 0 0 0
#  2014 2014 2011 2014 # after processing 
...
# 0.956	  #  control rule target as fraction Flimit (third catch stream - based on sigma  )
...
2027  #FirstYear for caps and allocations (should be after years with fixed inputs) 
...
#_Fleet:  TrawlSouth HL Setnet RecSouth RecCentral TrawlNor
