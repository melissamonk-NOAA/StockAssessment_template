...
1 # detailed output (0=minimal for data-limited, 1=high (w/ wtatage.ss_new)
# , 2=brief) 
...
1 # Depletion basis:  denom is: 0=skip; 1=rel X*SPB0; 2=rel SPBmsy; 3=rel X
# *SPB_styr; 4=rel X*SPB_endyr
...
# (Frates); 4=true F for range of ages; 5=unweighted avg. F for range of ag
# es
#COND 10 15 #_min and max age over which average F will be calculated with 
# F_reporting=4 or 5
0 # F_report_basis: 0=raw_F_report; 1=F/Fspr; 2=F/Fmsy ; 3=F/Fbtgt
0 # MCMC output detail: integer part (0=default; 1=adds obj func components
