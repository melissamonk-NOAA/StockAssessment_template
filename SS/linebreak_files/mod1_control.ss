...
# nt 
#
0   #_natM_type:_0=1Parm; 1=N_breakpoints;_2=Lorenzen;_3=agespecific;_4=age
# spec_withseasinterpolate
#1   #_N_breakpoints
#3   # age(real) at M breakpoints
1  # GrowthModel: 1=vonBert with L1&L2; 2=Richards with L1&L2; 3=age_specif
...
-0.09 -0.05  -0.13155 -0.13155 99 -1 -3 0 0 0 0 0.5 0 0 # Mat_slope_Fem_GP_
# 1
