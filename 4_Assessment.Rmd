...
`r #round(mod1$parameters[mod1$parameters$Label == "Q_extraSD_RecPR(4)", 3], 3)`

Recruitment deviations were estimated from yyyy to yyyy (Figure \ref{fig:recdevs2_withbars}). 


(Figures \ref{fig:ts11_Age-0_recruits_(1000s)_with_95_asymptotic_intervals} and 
\ref{fig:recdevs2_withbars}). 
