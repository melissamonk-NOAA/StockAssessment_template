---
title: 'Status of China Rockfish (*Sebastes nebulosus*) Along the U.S. Pacific Coast in 2015'
author: ''
date: ''
output:
  pdf_document:
...
Synthesis (3.xxx).  The model begins in `r Dat_start_mod1`, and assumes the stock 
