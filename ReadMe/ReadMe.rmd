...
Make sure you have the latest versions of the following programs installed on your machine:     
    ...
    * [RStudio](https://www.rstudio.com/products/rstudio/download3/) (Note: RStudio Preview will NOT work with the template until a bug is fixed)    
...
##Spell checking
Do not completely rely on RStudio's spell checker. Use the spell checker, but edit the document yourself as well.  There is not autocorrect function, as in Word.
...
* You have a space in a file name somewhere.  LaTeX cannot read file names with spaces.
