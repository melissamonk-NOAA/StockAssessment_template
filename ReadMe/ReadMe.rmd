...
Make sure you have the latest versions of the following programs installed on your machine:     
    ...
    * PC users: [MiKTeX](http://miktex.org/) or [TeX Live](https://www.tug.org/texlive/) (needed to render a .pdf to LaTeX)
    * Mac users: [MacTeX](http://www.tug.org/mactex/) (needed to render a .pdf to LaTeX)
    * [Mendeley](https://www.mendeley.com/) (optional, but useful for citation management)    
    
Eric Anderson has directions for the Git and R setup for Mac users [here](http://eriqande.github.io/rep-res-web/assign/assign-0.html#assignment-0).
...
* You have an illegal space or carriage return, most likley in the R markdown image syntax 
