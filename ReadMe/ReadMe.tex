...
fixed)\\
 * PC users: \href{http://miktex.org/}{MiKTeX} or
\href{https://www.tug.org/texlive/}{TeX Live} (needed to render a .pdf
to LaTeX) * Mac users: \href{http://www.tug.org/mactex/}{MacTeX} (needed
to render a .pdf to LaTeX) * \href{https://www.mendeley.com/}{Mendeley}
(optional, but useful for citation management)
...
\item
  You have an illegal space or carriage return, most likley in the R
